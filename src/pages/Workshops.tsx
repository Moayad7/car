...
import { Building2, MapPin, Phone, Clock, Star, ShieldCheck, Wrench } from 'lucide-react';
  ...
  'دمشق': [
    {
      ...
      description: 'متخصصون في صيانة وفحص السيارات الألمانية واليابانية، مع خبرة أكثر من 15 عام.',
      address: 'المزة - شارع الفيلات الغربية، دمشق',
      phone: '+963 11 123 4567',
      rating: 4.8,
      reviewCount: 124,
      workingHours: '8:00 ص - 6:00 م',
      services: ['فحص سيارات قبل الشراء', 'صيانة دورية', 'برمجة كمبيوتر', 'إصلاح ميكانيك', 'إصلاح كهرباء'],
      warrantyOffered: true,
      imageUrl: 'https://images.unsplash.com/photo-1613214149028-69e4fd713edb?auto=format&fit=crop&q=80&w=800'
    },
    {
      id: 'w2',
      name: 'مركز الأمان للسيارات',
      description: 'مركز متكامل لصيانة وإصلاح جميع أنواع السيارات الأوروبية والأمريكية والآسيوية.',
      address: 'المالكي - شارع عبد المنعم رياض، دمشق',
      phone: '+963 11 234 5678',
      rating: 4.5,
      reviewCount: 89,
      workingHours: '9:00 ص - 7:00 م',
      services: ['فحص سيارات شامل', 'صيانة محركات', 'إصلاح أنظمة التعليق', 'ضبط زوايا', 'تبديل زيوت'],
      warrantyOffered: true,
  ...
  'حلب': [
    {
      ...
      description: 'نقدم خدمات صيانة وإصلاح احترافية للسيارات بأيدي خبراء مهرة في مجال ميكانيك السيارات.',
      address: 'الشهباء - شارع بارون، حلب',
      phone: '+963 21 345 6789',
      rating: 4.7,
      reviewCount: 112,
      workingHours: '8:30 ص - 6:30 م',
      services: ['فحص شامل للسيارات', 'صيانة أنظمة التبريد', 'إصلاح نظام الفرامل', 'ميكانيك عام', 'كهرباء سيارات'],
      warrantyOffered: true,
  ...
  'حمص': [
    {
      ...
      description: 'نقدم خدمات صيانة احترافية لجميع أنواع السيارات مع ضمان الجودة والسرعة في الإنجاز.',
      address: 'الحمراء - شارع الملعب، حمص',
      phone: '+963 31 456 7890',
      rating: 4.3,
      reviewCount: 67,
      workingHours: '8:00 ص - 5:30 م',
      services: ['فحص قبل الشراء', 'برمجة كمبيوتر', 'صيانة دورية', 'تصليح العادم', 'ميزان وضبط زوايا'],
      warrantyOffered: false,
      imageUrl: 'https://images.unsplash.com/photo-1570470835458-064ce9be6325?auto=format&fit=crop&q=80&w=800'
    }
  ],
  'اللاذقية': [
    {
      ...
      description: 'ورشة متخصصة بصيانة السيارات الأوروبية والأمريكية مع خبرة تتجاوز 20 عاماً.',
      address: 'الصليبة - شارع 8 آذار، اللاذقية',
      phone: '+963 41 567 8901',
      rating: 4.6,
      reviewCount: 93,
      workingHours: '9:00 ص - 6:00 م',
      services: ['فحص شامل', 'صيانة دورية', 'برمجة كمبيوتر', 'إصلاح ميكانيك', 'إصلاح كهرباء', 'تبديل زيوت'],
      warrantyOffered: true,
  ...
  'طرطوس': [
    {
      ...
      description: 'نقدم خدمات متكاملة لفحص وصيانة وإصلاح جميع أنواع السيارات بأحدث التقنيات.',
      address: 'المشبكة - شارع الثورة، طرطوس',
      phone: '+963 43 678 9012',
      rating: 4.4,
      reviewCount: 71,
      workingHours: '8:30 ص - 5:30 م',
      services: ['فحص شامل', 'صيانة محركات', 'تشخيص أعطال', 'ميكانيك عام', 'كهرباء سيارات'],
      warrantyOffered: true,
      imageUrl: 'https://images.unsplash.com/photo-1606521568221-d8e04e2126df?auto=format&fit=crop&q=80&w=800'
    }
  ]
};
...
const Workshops = () => {
  ...
  const filteredWorkshops = workshopsMockData[selectedCity].filter(
    workshop => workshop.name.includes(searchQuery) || 
      ...
      <div className="container-custom py-28">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground max-w-3xl">
            تصفح قائمة ورش السيارات والمراكز المعتمدة للفحص والصيانة في جميع المدن السورية. بعض هذه الورش توفر ضمان على السيارات المستعملة بعد فحصها والتأكد من سلامتها.
          </p>
        </div>
        ...
        {/* City Tabs */}
        <Tabs defaultValue={selectedCity} onValueChange={setSelectedCity} className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredWorkshops.length > 0 ? (
                      ...
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="flex items-center gap-1 text-amber-500">
                            ...
                            <span className="text-xs text-muted-foreground">({workshop.reviewCount} تقييم)</span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-y-3 mb-6">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm">{workshop.workingHours}</span>
                          </div>
                          <div className="flex items-center gap-2">
                  ...
                  <div className="col-span-full text-center py-12">
                    ...
                    <h3 className="text-xl font-medium mb-2">لا توجد ورش مطابقة للبحث</h3>
                    <p className="text-muted-foreground">
                      لم نتمكن من العثور على أي ورش تطابق معايير البحث الخاصة بك.
                    </p>
                  </div>
                )}
              </div>
